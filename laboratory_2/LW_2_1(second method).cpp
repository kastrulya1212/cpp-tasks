...
struct Complex
{
    public:
        ...
        void init(double check_real, double check_imaginary);
        void read();
        void display();
...
void Complex::init(double check_real, double check_imaginary)
{
    cout << "Init checking..." << endl;
    real_a = check_real;
    imaginary_b = check_imaginary;
...
Complex operator+(Complex& obj1, Complex& obj2)
{
    Complex new_obj = Complex(
        obj1.real_a + obj2.real_a,
        obj1.imaginary_b + obj2.imaginary_b);
    return new_obj;
}
...
{
    Complex new_obj = Complex(
        (obj1.real_a*obj2.real_a) - (obj1.imaginary_b*obj2.imaginary_b),
        (obj1.real_a*obj2.imaginary_b) + (obj1.imaginary_b*obj2.real_a));
    return new_obj;
}

Complex operator/(Complex& obj1, Complex& obj2)
{
    if ((obj2.real_a*obj2.real_a + obj2.imaginary_b*obj2.imaginary_b == 0))
    {
    ...
    Complex new_obj = Complex(
        (obj1.real_a*obj2.real_a + obj1.imaginary_b*obj2.imaginary_b)/(obj2.real_a*obj2.real_a + obj2.imaginary_b*obj2.imaginary_b),
        (obj1.imaginary_b*obj2.real_a - obj1.real_a*obj2.imaginary_b)/(obj2.real_a*obj2.real_a + obj2.imaginary_b*obj2.imaginary_b));
    return new_obj;
}

bool operator==(Complex& obj1, Complex& obj2)
{
    return ((obj1.real_a==obj2.real_a) && (obj1.imaginary_b==obj2.imaginary_b));
}
